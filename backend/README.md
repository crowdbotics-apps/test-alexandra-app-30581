...
## Project Structure
    ...
    ├── test_alexandra_app_30581  # Django project configurations
...
1. Clone this repo and `cd test_alexandra_app_30581`
...
2. Clone this repo and `cd test_alexandra_app_30581`
